...
da = 0.01
rmf = ddme1_nmeos
e02,p02,r02=rmf(n0,2*da)
e01,p01,r01=rmf(n0,da)
e00,p00,r00=rmf(n0,0)
e10,p10,r10=rmf(n0,1.00)
print((e02-2.*e01+e00)/da**2*0.5)
print(e10-e00)
nm__main__('d',alf=0.0)from math import log, sqrt, exp
import scifig as sf 
import sys 
# definition of the parameters:
hc = 197.327
